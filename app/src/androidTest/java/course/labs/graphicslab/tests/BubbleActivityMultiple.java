...
public class BubbleActivityMultiple extends ActivityInstrumentationTestCase2<BubbleActivity>
{
    ...
    public void testRun()
    {
        ...
        assertEquals("Bubble hasn't appeared", 1, solo.getCurrentViews(
                course.labs.graphicslab.BubbleActivity.BubbleView.class).size());
        ...
        // Assert that a bubble was displayed
        assertEquals("Second bubble hasn't appeared", 2, solo.getCurrentViews(
                course.labs.graphicslab.BubbleActivity.BubbleView.class).size());
        ...
        assertEquals("There should be two bubbles on the screen", 2, solo.getCurrentViews(
                             course.labs.graphicslab.BubbleActivity.BubbleView.class).size());
    }
}
